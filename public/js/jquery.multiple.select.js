...
(function ($) {
    ...
    function MultipleSelect($el, options) {
        ...
        this.$choice = $('<button type="button" class="ms-choice"><span class="placeholder" id="placeholder">' +
    ...
    MultipleSelect.prototype = {
        ...
        init: function () {
            ...
            if (this.options.filter) {
                html.push(
                    '<div class="ms-search">',
                    '<input type="text" id="search_store"  autocomplete="off" spellcheck="false">',
                    '</div>'
                );
            }
            html.push('<ul>');
            if (this.options.selectAll && !this.options.single) {
                html.push(
                    ...
                    '<label>',
                    '<input id="ms-select-all" value="0" type="checkbox" ' + this.selectAllName + ' />',this.options.selectAllDelimiter[0]+this.options.selectAllText+this.options.selectAllDelimiter[1],
                    '</label>',
                    '</li>'
                );
            }
